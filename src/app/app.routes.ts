...
export const routes: Routes = [
  ...
  { path: 'people', loadChildren: () => import('./people/routes').then((m) => m.PEOPLE_ROUTES) },
  { path: 'test', loadChildren: () => import('./test/routes').then((m) => m.TEST_ROUTES) },
  ...
  { path: 'ag-grid-demo', loadComponent: () => import('./ag-grid-demo/ag-grid-demo.component').then((m) => m.AgGridDemoComponent) },
  { path: 'storage', loadComponent: () => import('./storage/storage.component').then((m) => m.StorageComponent) },
  { path: 'imask', loadComponent: () => import('./imask/imask.component').then((m) => m.ImaskComponent) },
