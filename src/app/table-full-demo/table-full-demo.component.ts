...
import { finalize, skip, Subject } from 'rxjs';
...
export class TableFullDemoComponent implements OnInit {
  ...
  private tableCellAvatarTemplate = viewChild.required<TemplateRef<{ $implicit: CellContext<IPerson, unknown> }>>('tableCellAvatar');
  ...
  public columnDefs: ComponentColumnDef<IPerson>[] = [
    ...
    },
    {
      ...
      maxSize: 56,
      align: CellAlign.Center,
      cell: () => this.tableCellAvatarTemplate()
    },
    {
      headerText: 'Id',
      accessorKey: 'id',
